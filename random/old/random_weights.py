# This is a script from the original Diehl and Cook codebase
# I made some modification so that it will work with python3
# this script generate the starting synaptic weights for the network.
# this will make the starting condition reproducable.
...
def create_weights():
    ...
    nInput = n_input #from the constants file
    nE = n_e
    nI = nE
